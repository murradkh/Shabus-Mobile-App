...
describe('MyClientPage Component:', () => {
  ...
  beforeEach(() => {
    ...
    authService = TestBed.get(Service);
    //   let el: DebugElement; 
  ...
  describe('Checking initial values:', () => {
    it('Client Counter value have to be 1', () => {
      expect(component.Num_Of_Passengers).toBe(1);
  ...
  describe('Checking the functions validition:', () => {
    it("addClient function:Client Counter maximum have to be 5", () => {
      component.addClient();
      expect(component.Num_Of_Passengers).toBe(2);
      component.Num_Of_Passengers = 5;
      component.addClient();
      expect(component.Num_Of_Passengers).toBeLessThan(6);
    });
    it('removeClient function:Client Counter value have to be minium 1', () => {
      component.removeClient();
      component.removeClient();
      expect(component.Num_Of_Passengers).toBeGreaterThan(0);
    });
